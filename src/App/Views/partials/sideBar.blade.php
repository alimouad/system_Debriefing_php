<aside class="w-72 glass border-r border-white/40 p-8 flex flex-col fixed h-full z-50 shadow-[20px_0_40px_rgba(0,0,0,0.02)]">
    ...
    <nav class="space-y-3 flex-1">
        ...
        <a href="/admin/dashboard" class="flex items-center justify-between group p-4 rounded-[1.5rem] transition-all duration-300 pink-gradient text-white shadow-xl shadow-pink-500/20">
        ...
        <a href="/admin/users" class="flex items-center justify-between group p-4 rounded-[1.5rem] transition-all duration-300 text-slate-400 hover:text-primary hover:bg-pink-50/50">
            <div class="flex items-center gap-4">
        ...
        <a href="/admin/classroom" class="flex items-center justify-between group p-4 rounded-[1.5rem] transition-all duration-300 text-slate-400 hover:text-primary hover:bg-pink-50/50">
            <div class="flex items-center gap-4">
        ...
        <a href="/admin/skills" class="flex items-center justify-between group p-4 rounded-[1.5rem] transition-all duration-300 text-slate-400 hover:text-primary hover:bg-pink-50/50">
            <div class="flex items-center gap-4">
        ...
        <a href="/admin/sprints" class="flex items-center justify-between group p-4 rounded-[1.5rem] transition-all duration-300 text-slate-400 hover:text-primary hover:bg-pink-50/50">
            <div class="flex items-center gap-4">
