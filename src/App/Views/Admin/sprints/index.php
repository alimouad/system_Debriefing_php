<div class="space-y-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
    ...
    <header class="flex flex-col md:flex-row md:items-end justify-between gap-6 px-4">
        <div>
            ...
            <h1 class="text-5xl font-black text-slate-900 tracking-tight leading-none">Manage <span class="text-transparent bg-clip-text pink-gradient">Sprints</span></h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 px-2">
        ...
        <?php foreach ($sprints as $sprint): ?>
            ...
            <div class="<?= $isActive ? 'bg-white/80 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)] border-white' : 'bg-white/40 opacity-80 border-white/50' ?> backdrop-blur-3xl rounded-[3.5rem] p-9 border relative overflow-hidden group hover:shadow-2xl transition-all duration-700 hover:-translate-y-1">
                ...
                <div class="mb-8">
                    ...
                    <div class="flex items-center gap-2">
                         ...
                         <p class="text-slate-400 text-[10px] font-black uppercase tracking-widest">
                            <?= htmlspecialchars($sprint['classroom_name'] ?? 'Unassigned Class') ?>
                        </p>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between pt-8 border-t border-slate-100/60">
                    ...
                    <div class="flex gap-2">
                        <a href="/admin/sprints/edit?id=<?= $sprint['id'] ?>" class="w-12 h-12 rounded-2xl bg-white text-slate-300 hover:text-primary hover:shadow-xl hover:border-pink-100 border border-transparent flex items-center justify-center transition-all duration-300">
